...
public class StoreController {
    ...
    public ResponseEntity<ApiResponse> createStore(@RequestBody CreateStore createStore) throws Exception {
        try{
            Store store = storeService.createStore(createStore.getStoreName(), createStore.getLocation(), createStore.getOwnerId(), createStore.getOwnerName(), createStore.getStoreurl_img());
